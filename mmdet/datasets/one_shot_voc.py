...
class OneShotVOCDataset(CustomDataset):
    ...
    def prepare_train_img(self, idx):
        ...
        result['img_metas'].data['img_flip'] = result['Img_Flip']
        del result['Img_Flip']
    ...
    def prepare_test_img(self, idx):
        ...
        ###########yuqi###############################
        #result = self.pipeline(results)
        #result['img_metas'][0].data['Img_Resize'] = result['Img_Resize']
        #del result['Img_Resize']
        #return result
        ###########yuqi###############################

        ###########yuqi###############################
        result = self.pipeline(results)
        result['img_metas'][0].data['img_flip'] = result['Img_Flip']
        del result['Img_Flip']
        return result
        ###########yuqi###############################
